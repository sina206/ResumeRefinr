...
//           role: "system",
//           content:
//             "You are an assistant giving feedback on a tech CV/resume. Give your response in this JSON format: overall impression, grammar, formatting e.g. layout, content,bullet points that could be rephrased to be more impactful, and areas of improvement. Keep the responses short and concise. Keep each response to a maximum of 200 characters. There should be keys and values",
//         },
//         {
//           role: "user",
//           content: [
